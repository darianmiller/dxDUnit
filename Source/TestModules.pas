{ $Id: TestModules.pas 15 2008-08-14 20:03:14Z medington $ }
{: DUnit: An XTreme testing framework for Delphi programs.
   @author  The DUnit Group.
   @version $Revision: 15 $ 2001/03/08 uberto
}
(*
...
const
  rcs_id :string = '#(@)$Id: TestModules.pas 15 2008-08-14 20:03:14Z medington $';
