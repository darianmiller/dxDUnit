{#(@)$Id: TestFramework.pas 26 2009-05-25 11:41:22Z neuromancer $ }
...
const
  rcs_id: string = '#(@)$Id: TestFramework.pas 26 2009-05-25 11:41:22Z neuromancer $';
  rcs_version : string = '$Revision: 26 $';
